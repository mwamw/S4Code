...
class ProjectContext:
    ...
    @classmethod
    def detect(cls, cwd: str | Path | None = None, *, git_binary: str = "git") -> "ProjectContext":
    ...
    def run_git(self, args: list[str], *, check: bool = False) -> subprocess.CompletedProcess[str]:
